    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DEPID', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='hospial.dept')),
            ],
        ),
        migrations.CreateModel(
            name='login',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('LOGIN', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='hospial.login')),
            ],
        ),
        migrations.CreateModel(
            name='staff',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DOCID', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='hospial.doctor')),
            ],
        ),
        migrations.CreateModel(
            name='leavereq',
            fields=[
                ...
                ('STAFFID', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='hospial.staff')),
            ],
        ),
        migrations.AddField(
            model_name='doctor',
            name='LOGIN',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='hospial.login'),
        ),
        migrations.CreateModel(
            name='booking',
            fields=[
                ...
                ('SCHDID', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='hospial.schedule')),
            ],
        ),
        migrations.CreateModel(
            name='attendance',
